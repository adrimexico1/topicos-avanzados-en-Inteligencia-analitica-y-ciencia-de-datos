...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Lab1 - regresion lineal. Adrimexico1',
      theme: ThemeData(
      ...
      home: const MyHomePage(title: 'lab1 - regresion  lineal Adrimexico1'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> linearModelPredict(BuildContext context, String instancia) async {
    const String serverUrl =
        'https://tensorflow-serving-linear-ex0g.onrender.com/v1/models/linear-model:predict';
